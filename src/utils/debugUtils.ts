...
export const debugEnvironment = () => {
  ...
  console.log('环境变量:', {
    ...
    VITE_REPO_OWNER: import.meta.env.VITE_REPO_OWNER ? '已设置' : '未设置',
    VITE_REPO_NAME: import.meta.env.VITE_REPO_NAME ? '已设置' : '未设置',
  ...
  console.log('是否为Cloudflare Pages:', isCloudflarePages)
